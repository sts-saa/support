...
const useCases = [
  {
    ...
    title: "IT-поддержка",
    example: {
      title: "На каждую заявку — один ответ, без хаоса",
      description: "Сотрудник пишет в чат, система понимает проблему и направляет её нужному специалисту. Всё фиксируется — никто не теряется, ничего не забывается.",
      features: [
        "Автоматическое определение типа проблемы: оборудование, программы, доступы",
        "Подключение к корпоративным системам",
        "Автоматизация частых запросов",
  ...
  },
  {
    ...
    example: {
      title: "Вернуть клиента до того, как он уйдёт",
  ...
  },
  {
    ...
    example: {
      ...
      description: "Жильцы сканируют QR-код, пишут в чат. Система сделает все остальное.",
      features: [
    ...
    <section id="use-cases" className="py-16 md:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <SectionTitle 
          ...
          subtitle="Подходит тем, кто часто сталкивается с большим потоком обращений и должен реагировать быстро"
          center
        />
