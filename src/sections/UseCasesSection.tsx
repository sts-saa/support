...
const useCases = [
  {
    ...
    example: {
      ...
      description: "Сотрудник пишет в чат, а система понимает проблему и направляет её нужному специалисту. Всё фиксируется — никто не теряется, ничего не забывается.",
      features: [
