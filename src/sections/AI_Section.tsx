  ...
  return (
    <section id="ai-section" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <SectionTitle 
          title={<><span className="text-primary font-bold">Скоро:</span> умный помощник для вашей команды</>}
        ...
        <div className="text-center mt-8">
          <p className="text-gray-500 italic">Уже в разработке. Запуск в ближайших релизах.</p>
        </div>
      </div>
    </section>
  );
