        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 mb-6">
                Чтобы хоть как-то навести порядок, все начинали внедрять "тяжёлые" системы. Но всё заканчивалось одинаково — либо никто не хотел ими пользоваться, либо поддержка превращалась в бюрократию: тикеты, статусы, назначенные ответственные, куча кнопок и полей.
              </p>
